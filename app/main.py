...
from .routes import graphs, instances, collections, vpns, endpoint_selection
...
app.include_router(endpoint_selection.router, prefix="/api/v1", tags=["endpoint-selection"])
